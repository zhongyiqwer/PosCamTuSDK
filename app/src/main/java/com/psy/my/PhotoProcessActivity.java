...
public class PhotoProcessActivity extends Activity implements View.OnClickListener {
	...
	public  void saveImageToGallery(Context context, Bitmap bmp) {
		// 首先保存图片
		File appDir = new File(Environment.getExternalStorageDirectory(), "PoseCamera");
		if (!appDir.exists()) {
			appDir.mkdir();
		}
		String fileName = System.currentTimeMillis() + ".jpg";
		path = Environment.getExternalStorageDirectory()+"/PoseCamera/"+fileName;
